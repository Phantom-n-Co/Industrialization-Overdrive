...
public final class IOItems {
    ...
    public static final ItemHolder<UpgradeHolder> UPGRADE_HOLDER = create("upgrade_holder", "Upgrade Holder", UpgradeHolder::new, IOSortOrder.GEAR).withModelBuilder(CommonModelBuilders::generated).register();
